<%-- 
    Document   : addProduct
    Created on : Dec 19, 2025, 10:45:13 PM
    Author     : dotha
--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addProductForm" action="${pageContext.request.contextPath}/ProductAdminServlet?action=add" method="POST" enctype="multipart/form-data">
                    <!--Name-->
